  ...
  return (
    <>
      <main className="bg-container min-h-screen pb-64">
        ...
        <div className="container mt-5 mx-auto py-28">
          <h2
            style={{ fontSize: "90px" }}
            className="font-bold text-center heading"
          >
            Hi I'm Mante!
          </h2>
        ...
        <div className="container mx-auto mt-64">
          <h2
            style={{ fontSize: "70px" }}
            className="font-bold text-center mb-12 heading"
          >
            How To Buy?
          </h2>
        ...
        <div className="container mx-auto mt-64">
          ...
          <div className="font-bold mt-16">
            <h2 className="text-4xl text-center mb-5">Token Supply: </h2>
            <h1 className="text-6xl text-center mb-5">1,000,000,000 </h1>
            <h3 className="text-2xl text-center">No taxes, keep it simple</h3>
          </div>
        </div>
      </main>
    </>
